<div class="relative mb-6 w-full">
    <flux:heading size="xl" level="1">{{ __('Question Create') }}</flux:heading>
    <flux:subheading size="lg" class="mb-6">{{ __('Add Question here') }}</flux:subheading>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 md:p-8">
        <form wire:submit.prevent="createQuestion" class="space-y-6">
            ...
            <div class="pt-2">
                ...
                <div class="grid grid-cols-2 gap-3 sm:grid-cols-4">
                    ...
                    <div class="flex items-center">
                            <input type="radio" wire:model="rightAnswer" value="a" id="answer1"
                                class="h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300">
                            <label for="answer1" class="ml-2 text-gray-700">Option A</label>
                    </div>
                    <div class="flex items-center">
                            <input type="radio" wire:model="rightAnswer" value="b" id="answer2"
                                class="h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300">
                            <label for="answer2" class="ml-2 text-gray-700">Option B</label>
                    </div>
                    <div class="flex items-center">
                            <input type="radio" wire:model="rightAnswer" value="c" id="answer3"
                                class="h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300">
                            <label for="answer3" class="ml-2 text-gray-700">Option C</label>
                    </div>
                    <div class="flex items-center">
                            <input type="radio" wire:model="rightAnswer" value="d" id="answer4"
                                class="h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300">
